...
public class SpeciesListStage implements AdventureStage {
  ...
  public void playStage() {
    ...
    System.out
        .println("- This native american bovine can be found in the plains, and happens to be EXTREMELY good at Java.");
    ...
    System.out
        .println("- These tiny birds flap very fast, drink nectar, and know how to make simpler Java appplications.");
    System.out.println("- Type their names into the terminal (separated by ',')");
